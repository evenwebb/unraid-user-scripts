...
| **clear-movies-download-folder.sh** | Empties the movies download directory and prints a summary.<br>📝 **Config:** `DIR_PATH`, optional `NOTIFY_SCRIPT`, optional `LOG_FILE`<br>📬 **Notifications:** Optional Unraid dynamix notify |
| **clear-plex-codecs.sh** | Deletes Plex Media Server codec cache (Plex re-downloads as needed).<br>📝 **Config:** `PLEX_CODECS_PATH` |
| **clear-torrent-download-folder.sh** | Empties the torrent download directory and prints a summary.<br>📝 **Config:** `DIR_PATH`, optional `NOTIFY_SCRIPT`, optional `LOG_FILE`<br>📬 **Notifications:** Optional Unraid dynamix notify |
| **clear-tv-shows-download-folder.sh** | Empties the TV shows download directory and prints a summary.<br>📝 **Config:** `DIR_PATH`, optional `NOTIFY_SCRIPT`, optional `LOG_FILE`<br>📬 **Notifications:** Optional Unraid dynamix notify |
