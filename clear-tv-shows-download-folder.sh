...
# Empties the TV shows download directory and optionally sends a notification
#
# Description:
#   Counts and measures the TV shows download folder, deletes all contents,
...
# TV shows download directory - EDIT FOR YOUR SETUP
...
main() {
    ...
    log "$summary"
    send_pushover "TV Show Downloads Cleared" "$summary"
}
